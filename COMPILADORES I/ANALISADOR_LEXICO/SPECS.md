...
## Visão Geral:
Utilizando a ferramenta Flex e a linguagem C, implemente um analisador léxico para um subconjunto de tokens da linguagem C. Para cada token reconhecido, você deverá imprimir a classificação do mesmo. 
